...
export const PERMISSIONS = {
  ...
  ALLOWANCES_UPDATE: 'allowances.update',
  PENSION_VIEW: 'pension.view',
  PENSION_UPDATE: 'pension.update',
  PENSION_MANAGE: 'pension.manage',
  INCREMENTS_VIEW: 'increments.view',
  INCREMENTS_UPDATE: 'increments.update',
  INCREMENTS_GENERATE: 'increments.generate',
