...
export const pageNavItems: ReadonlyArray<{
  ...
  {
    key: 'increments',
    href: '/increments/overview',
    label: 'Increments',
    icon: '📈',
    section: 'main',
    children: [
      { key: 'incrementsOverview', href: '/increments/overview', label: 'Overview', icon: '📘' },
      { key: 'incrementsScales', href: '/increments/scales', label: 'BPS Scales', icon: '🧮' },
    ],
  },
