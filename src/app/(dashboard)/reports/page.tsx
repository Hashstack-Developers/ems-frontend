...
const reportTypes: ReportTypeConfig[] = [
  ...
  },
  {
    ...
    label: 'Taxes Report',
    icon: '📊',
    description: 'Applied income tax deductions per employee for the selected period.',
    fields: ['Per-employee tax applied', 'Gross & income tax', 'Tax slab & rate', 'Period totals'],
    requiresPeriod: true,
    color: 'orange',
  },
  {
